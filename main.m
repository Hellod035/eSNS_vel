...
% 关节物理极限
dqmax=[0.3,0.3,0.3,0.3,0.3,0.3,0.3]';dqlow=-dqmax;
...
% 关节笛卡尔极限
cartesian_bound_target="panda_link5";
xbound=[[-10;-10;-10],[10;10;0.85]];
...
for s=(1:steps-1)
    ...
    A_LIM=eye(7);
    ur={};
    ur{1,1}=zeros(7,1);ur{2,1}=zeros(7,1);ur{3,1}=zeros(7,1);
    A={};
    A{1,1}=J(1,:);
    A{2,1}=J(2,:);
    A{3,1}=J(3,:);
